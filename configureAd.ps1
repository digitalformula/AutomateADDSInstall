...
# $credential = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList "ntnxdemo13\administrator",$password
$credential = New-Object System.Management.Automation.PSCredential ('ntnxdemo13\administrator', (ConvertTo-SecureString 'nutanix/4u' -AsPlainText -Force))
